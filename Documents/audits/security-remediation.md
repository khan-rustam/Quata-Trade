...
| 6 | **At-rest encryption thin + no vault** | Prod env hard-stops (6a) + at-rest encryption of KYC/PII objects via MinIO SSE-S3 (6b). Vault/HSM + DB volume/TDE encryption = ops (document). | **done — CI-verify** |

...
/**
 * Themed area/bar trend chart. Client-only (recharts measures the DOM) and loaded
 * lazily via metric-chart.tsx so the ~heavy recharts bundle never ships with the
